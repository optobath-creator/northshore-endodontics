  ...
  return <div className="site">
    <div className={`sticky-cta${showStickyCta ? ' is-active' : ''}`} aria-hidden={!showStickyCta}>
      <div className="container sticky-cta-in">
        <a className="sticky-phone btn btn-ghost btn-on-dark" href="tel:+18474801578" aria-label="Call North Shore Endodontics at (847) 480-1578" tabIndex={showStickyCta ? 0 : -1}><Phone size={16} /> (847) 480-1578</a>
        <a className="btn btn-primary" href="#contact" tabIndex={showStickyCta ? 0 : -1}>Book Appointment</a>
      </div>
    </div>

    <header><div className="container head-in"><div className="brand" aria-label="North Shore Endodontics"><img src="/assets/northshore-logo.webp" alt="North Shore Endodontics" /><a className="header-phone btn btn-ghost btn-on-dark" href="tel:+18474801578" aria-label="Call North Shore Endodontics at (847) 480-1578"><Phone size={16} /> (847) 480-1578</a></div></div></header>

    <main id="top">
      <section className="hero reveal-section" ref={heroRef} data-reveal><img className="hero-image" src="/assets/hero-care.webp" alt="Patient smiling during a comfortable dental visit" width="1140" height="400" fetchPriority="high" /><div className="container hero-in"><div><p className="eyebrow light">Specialized care. Lasting confidence.</p><h1>Keep your natural smile <em>healthy.</em></h1><p className="lead">Expert endodontic care with a calm, personal approach—so you can get back to the moments that make you smile.</p><div className="note"><ShieldCheck size={18} /> Proudly serving Northbrook and the North Shore</div></div><aside><small>A thoughtful next step</small><p>“You deserve to understand your care and feel comfortable with the plan.”</p><b /></aside></div></section>

      <section className="section container intro reveal-section" data-reveal><small className="eyebrow">A better endodontic experience</small><div><h2>Specialized care, delivered with <em>clarity.</em></h2><div><p>At North Shore Endodontics, we combine advanced technology with the kind of personal attention that makes a difference. From your first call to your final follow-up, you’ll know what to expect.</p></div></div></section>
      ...
      <section className="section resources reveal-section" id="patients" data-reveal><div className="container"><div className="heading"><div><small className="eyebrow">Forms & resources</small><h2>Prepare before<br /><em>your first visit.</em></h2></div><p>Complete patient forms in advance, or download a referral card for a patient who needs specialty care.</p></div><div className="visit-expectations"><div><small>What to expect</small><h3>A clear plan from the first conversation.</h3><p>Bring your completed forms and any questions you have. We’ll review your concerns, explain the diagnosis, and discuss your treatment options with you.</p></div></div><div className="resource-cards"><a className="resource-card btn btn-ghost" href="/forms/patient-registration-editable.pdf" target="_blank" rel="noreferrer"><span>PDF form</span><h3>Patient registration</h3><p>Contact details, insurance, and emergency information.</p><strong>Open form <ArrowRight size={15} /></strong></a><a className="resource-card btn btn-ghost" href="/forms/medical-history-editable.pdf" target="_blank" rel="noreferrer"><span>PDF form</span><h3>Medical history</h3><p>Medical questions, medications, allergies, and physician details.</p><strong>Open form <ArrowRight size={15} /></strong></a><a className="resource-card btn btn-ghost" href="/forms/hipaa-notice-2026-editable.pdf" target="_blank" rel="noreferrer"><span>Updated February 2026</span><h3>HIPAA notice</h3><p>Review the updated privacy notice and complete the acknowledgment.</p><strong>Open form <ArrowRight size={15} /></strong></a><a className="resource-card btn btn-ghost" href="/forms/referral-card.jpg" target="_blank" rel="noreferrer"><span>Referring dentists</span><h3>Referral card</h3><p>Download and share this referral card with a patient who needs endodontic care.</p><strong>Open referral card <ArrowRight size={15} /></strong></a></div></div></section>
