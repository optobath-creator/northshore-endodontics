...
function App() {
  ...
  return <div className="site">
    ...
    <main id="top">
      ...
      <section className="section education reveal-section" id="education" data-reveal><div className="container"><div className="heading"><div><small className="eyebrow">Patient education</small><h2>Understand your<br /><em>endodontic care.</em></h2></div><p>Trusted information from the American Association of Endodontists, organized around the questions patients ask most often.</p></div><div className="education-links"><a className="education-link" href="https://www.aae.org/patients/root-canal-treatment/" target="_blank" rel="noreferrer"><div><small>American Association of Endodontists</small><h3>Root canal treatment</h3><p>Learn what a root canal is, how treatment works, its benefits, comfort, cost, and common myths.</p></div><ArrowRight size={22} aria-hidden="true" /></a><a className="education-link" href="https://www.aae.org/patients/dental-symptoms/" target="_blank" rel="noreferrer"><div><small>American Association of Endodontists</small><h3>Dental symptoms</h3><p>Explore guidance for tooth pain, cracked teeth, abscesses, and traumatic dental injuries.</p></div><ArrowRight size={22} aria-hidden="true" /></a></div></div></section>
